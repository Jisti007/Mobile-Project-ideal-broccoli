...
extern "C" {
    JNIEXPORT void JNICALL Java_xyz_asdasd_gles3jni_GLES3JNILib_init(JNIEnv* env, jobject obj);
    JNIEXPORT void JNICALL Java_xyz_asdasd_gles3jni_GLES3JNILib_resize(JNIEnv* env, jobject obj, jint width, jint height);
...
Java_xyz_asdasd_gles3jni_GLES3JNILib_init(JNIEnv* env, jobject obj) {
    if (g_renderer) {
        delete g_renderer;
        g_renderer = NULL;
    }
